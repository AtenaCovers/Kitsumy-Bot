...
global.authFile = `KitsumySession`;
...
const connectionOptions = {
  ...
  browser: ['KitsumyBot, 'Atena', '1.0.0'],
  version,
...
setInterval(async () => {
  ...
  const bio = `🤖 ᴛɪᴇᴍᴘᴏ ᴀᴄᴛɪᴠᴏ: ${uptime} ┃ 👑 David Delgado ┃ 🔗 ᴄᴜᴇɴᴛᴀs ᴏғᴄ: https://www.atom.bio/theshadowbrokers-team`;
